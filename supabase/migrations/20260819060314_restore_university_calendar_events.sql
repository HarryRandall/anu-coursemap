-- Restore the university calendar after its source table was removed. Keep the
-- original addition and removal migrations immutable so deployed databases can
-- progress through the same history.
