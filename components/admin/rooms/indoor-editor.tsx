...
import {
  ...
  EditorHint,
  type SnapSettings,
} from "@/components/admin/rooms/editor-status-bar";
import styles from "@/components/admin/rooms/indoor-editor.module.css";
import {
  IndoorMapSurface,
  type IndoorMapSurfaceHandle,
} from "@/components/admin/rooms/indoor-map-surface";
import {
  Inspector,
  type InspectorTab,
} from "@/components/admin/rooms/inspector";
import { LevelPill } from "@/components/admin/rooms/level-pill";
import type { SelectionDetailsHandlers } from "@/components/admin/rooms/properties-panel";
import {
  ToolRail,
  toolDefinition,
  toolForShortcut,
  type IndoorTool,
} from "@/components/admin/rooms/tool-rail";
import { useEditorPointer } from "@/components/admin/rooms/use-editor-pointer";
import { useIndoorPalette } from "@/components/admin/rooms/use-indoor-palette";
import { useUnsavedNavigation } from "@/components/admin/rooms/use-unsaved-navigation";
import type { IndoorLayerGroup } from "@/components/rooms/indoor-3d-layers";
