...
import {
  Gantt,
  type GanttApi,
} from "@reui/components/gantt/gantt"
import type { GanttI18nOverrides } from "@reui/components/gantt/gantt-i18n"
import {
  GanttNav,
  GanttToolbar,
} from "@reui/components/gantt/gantt-nav"
import type {
  GanttEvent,
  GanttInteractions,
  GanttResource,
  GanttSlotDraft,
} from "@reui/components/gantt/gantt-types"
import { GanttView } from "@reui/components/gantt/gantt-view"
...
const SETTINGS_DEFAULTS = {
  ...
  infiniteScroll: true,
  // A live percentage changes between SSR and hydration. Keep the optional
  // marker off by default in Coursemap's server-rendered laboratory.
  nowIndicator: false,
  offDays: false,
  dragCreate: true,
