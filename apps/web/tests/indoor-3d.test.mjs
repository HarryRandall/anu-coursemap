...
const modules = {
  "indoor-3d": await import("../lib/rooms/indoor-3d.ts"),
  "indoor-footprint": await import("../lib/rooms/indoor-footprint.ts"),
  "indoor-map-migrate": await import("../lib/rooms/indoor-map-migrate.ts"),
  "indoor-lift-animation":
    await import("../lib/rooms/indoor-lift-animation.ts"),
  "indoor-stairs": await import("../lib/rooms/indoor-stairs.ts"),
};
