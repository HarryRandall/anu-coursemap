...
const {
  ...
  "indoor-drag": await import("../lib/rooms/indoor-drag.ts"),
  "indoor-draft": await import("../lib/rooms/indoor-draft.ts"),
  "indoor-palette": await import("../lib/rooms/indoor-palette.ts"),
};
