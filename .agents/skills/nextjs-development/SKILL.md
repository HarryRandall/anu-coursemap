...
- Keep reusable domain calculations in `apps/web/lib/` with typed inputs. Route handlers and server actions should validate requests, enforce access, call domain code and translate the result.
