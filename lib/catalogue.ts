...
export const courses: Course[] = [
  {
    ...
    sessions: ["Semester 1"],
    delivery: "In person",
    description: "A first course in programming, computational thinking and systematic problem solving.",
  ...
  },
  {
    ...
    delivery: "In person",
    description: "Discrete structures and mathematical reasoning used throughout computing.",
    prerequisiteText: "None",
    prerequisiteCodes: [],
  ...
  },
  {
    ...
    sessions: ["Semester 2"],
    delivery: "In person",
    description: "Object-oriented design, data structures and larger-scale programming practice.",
  ...
  },
  {
    ...
    sessions: ["Semester 2"],
    delivery: "In person",
    description: "Logical and mathematical foundations for analysing computation and algorithms.",
    prerequisiteText: "None",
    prerequisiteCodes: [],
  ...
  },
  {
    ...
    sessions: ["Semester 1"],
    delivery: "In person",
    description: "Techniques for designing, testing and maintaining reliable software systems.",
  ...
  },
  {
    ...
    sessions: ["Semester 2"],
    delivery: "In person",
    description: "Team-based software engineering, requirements, architecture and delivery practices.",
  ...
  },
  {
    ...
    sessions: ["Semester 1"],
    delivery: "In person",
    description: "How programs execute across instruction sets, memory and processor architecture.",
  ...
  },
  {
    ...
    sessions: ["Semester 2"],
    delivery: "In person",
    description: "Operating systems, networks, concurrency and the design of reliable systems software.",
  ...
  },
  {
    ...
    sessions: ["Semester 1", "Semester 2"],
    delivery: "Hybrid",
    description: "Data modelling, relational theory, SQL and dependable database application design.",
  ...
  },
  {
    ...
    sessions: ["Semester 2"],
    delivery: "In person",
    description: "Mathematical foundations of information, coding, compression and communication.",
  ...
  },
  {
    ...
    sessions: ["Semester 2"],
    delivery: "Hybrid",
    description: "Technical, legal and social dimensions of cybercrime and digital investigations.",
  ...
  },
  {
    ...
    sessions: ["Semester 1"],
    delivery: "In person",
    description: "Design and analysis of efficient algorithms for challenging computational problems.",
  ...
  },
  {
    ...
    sessions: ["Semester 2"],
    delivery: "In person",
    description: "Search, reasoning, planning and learning techniques for intelligent systems.",
    prerequisiteText: "COMP2100 and MATH1005",
    prerequisiteCodes: ["COMP2100", "MATH1005"],
    incompatibilities: ["COMP6320"],
    countsTowards: ["Intelligent Systems major", "3000-level computing requirement"],
  ...
  },
  {
    ...
    sessions: ["Semester 1"],
    delivery: "In person",
    description: "Secure software design, implementation, testing and vulnerability analysis.",
  ...
  },
  {
    ...
    sessions: ["Semester 1", "Semester 2"],
    delivery: "Project",
    description: "A substantial team project integrating technical knowledge and professional practice.",
    prerequisiteText: "96 units completed, including COMP2100",
    prerequisiteCodes: ["COMP2100"],
    incompatibilities: ["COMP6390"],
    permissionText: "Permission from the course convener is required before enrolment.",
...
export const degrees: Degree[] = [
  {
    ...
    description: "A flexible computing degree with a major, core courses and room for electives.",
  },
  {
    code: "BACOMPH",
    ...
    duration: 4,
    college: "College of Systems and Society",
    description: "An intensive computing programme with advanced study and an honours research year.",
  },
  {
    code: "BIT",
    ...
    duration: 3,
    college: "College of Systems and Society",
    description: "Applied information technology with flexible computing and university electives.",
  },
];
...
export const majors: Major[] = [
  ...
  },
  {
    ...
    units: 48,
    colour: "#e05f7e",
    description: "Secure software, systems, networks and information infrastructure.",
    courseCodes: ["COMP1100", "COMP1110", "COMP2300", "COMP2310", "COMP3430", "COMP3703"],
  },
  {
    code: "DASC-MAJ",
    name: "Data Science",
...
export const terms: Term[] = [
  { id: "2026-s1", year: 2026, name: "Semester 1", shortName: "S1", dates: "Feb - Jun" },
  { id: "2026-s2", year: 2026, name: "Semester 2", shortName: "S2", dates: "Jul - Nov" },
  { id: "2027-s1", year: 2027, name: "Semester 1", shortName: "S1", dates: "Feb - Jun" },
  { id: "2027-s2", year: 2027, name: "Semester 2", shortName: "S2", dates: "Jul - Nov" },
  { id: "2028-s1", year: 2028, name: "Semester 1", shortName: "S1", dates: "Feb - Jun" },
  { id: "2028-s2", year: 2028, name: "Semester 2", shortName: "S2", dates: "Jul - Nov" },
  { id: "unscheduled", year: 2029, name: "Later", shortName: "Later", dates: "Not scheduled" },
];

export const initialAttempts: Attempt[] = [
  { id: "a-comp1100", courseCode: "COMP1100", termId: "2026-s1", status: "completed", mark: 78 },
  { id: "a-math1005", courseCode: "MATH1005", termId: "2026-s1", status: "completed", mark: 72 },
  { id: "a-comp1110-fail", courseCode: "COMP1110", termId: "2026-s2", status: "failed", mark: 43 },
  { id: "a-comp1600", courseCode: "COMP1600", termId: "2026-s2", status: "planned" },
  { id: "a-comp1110-repeat", courseCode: "COMP1110", termId: "2027-s1", status: "planned" },
  { id: "a-comp2100", courseCode: "COMP2100", termId: "2027-s2", status: "planned" },
  { id: "a-comp2120", courseCode: "COMP2120", termId: "2028-s1", status: "planned" },
  { id: "a-comp3900", courseCode: "COMP3900", termId: "2028-s2", status: "planned" },
];

export const relations: Relation[] = [
  { id: "r1", source: "COMP1110", relation: "Prerequisite", target: "COMP1100", group: "one_of:1", hardness: "Hard", confidence: 99, state: "Verified", sourceText: "Completion of COMP1100 or COMP1130" },
  { id: "r2", source: "COMP2100", relation: "Prerequisite", target: "COMP1110", group: "all_of:1", hardness: "Hard", confidence: 100, state: "Verified", sourceText: "Successful completion of COMP1110" },
  { id: "r3", source: "COMP2300", relation: "Prerequisite", target: "COMP1110", group: "all_of:1", hardness: "Hard", confidence: 98, state: "Automatic", sourceText: "COMP1110 and COMP1600" },
  { id: "r4", source: "COMP2300", relation: "Prerequisite", target: "COMP1600", group: "all_of:1", hardness: "Hard", confidence: 98, state: "Automatic", sourceText: "COMP1110 and COMP1600" },
  { id: "r5", source: "COMP3900", relation: "Permission", target: "Course convener", group: "all_of:2", hardness: "Hard", confidence: 100, state: "Verified", sourceText: "...and permission of the course convener" },
  { id: "r6", source: "COMP2100", relation: "Incompatible", target: "COMP6442", group: "incompat:1", hardness: "Hard", confidence: 97, state: "Automatic", sourceText: "Incompatible with COMP6442" },
  { id: "r7", source: "BCOMP", relation: "Requires", target: "SOFT-MAJ", group: "structure:major", hardness: "Allocation", confidence: 96, state: "Automatic", sourceText: "48 units from completion of one listed major" },
  { id: "r8", source: "COMP2610", relation: "Prerequisite", target: "6 units programming", group: "all_of:2", hardness: "Hard", confidence: 71, state: "Review", sourceText: "MATH1005 and at least 6 units of programming courses" },
];
...
export const requirementGroups = [
  ...
  { id: "electives", name: "University electives", description: "Courses chosen from across ANU", total: 24, colour: "#e05f7e" },
];
